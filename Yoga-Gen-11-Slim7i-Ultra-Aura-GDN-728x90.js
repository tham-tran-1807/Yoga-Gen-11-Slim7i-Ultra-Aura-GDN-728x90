...
lib.ssMetadata = [
		{name:"Yoga_Gen_11_Slim7i_Ultra_Aura_GDN_728x90_atlas_1", frames: [[0,736,50,50],[0,0,728,90],[0,92,728,90],[0,184,728,90],[0,276,728,90],[0,368,728,90],[0,460,728,90],[0,552,728,90],[0,644,728,90]]}
];
...
(lib.arrows_w = function() {
	this.initialize(ss["Yoga_Gen_11_Slim7i_Ultra_Aura_GDN_728x90_atlas_1"]);
	this.gotoAndStop(0);
...
(lib.Frame8_1 = function(mode,startPosition,loop,reversed) {
...
}).prototype = getMCSymbolPrototype(lib.Frame8_1, new cjs.Rectangle(0,0,728,90), null);
...
// stage content:
(lib.YogaGen11Slim7iUltraAuraGDN728x90 = function(mode,startPosition,loop,reversed) {
...
if (reversed == null) { reversed = false; }
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(422).call(this.frame_422).wait(28));
	...
	this.timeline.addTween(cjs.Tween.get(this.btn_replay).wait(421).to({_off:false},0).wait(29));
	...
	this.timeline.addTween(cjs.Tween.get(this.mc_mui_ten_xoay).wait(421).to({_off:false},0).to({y:10.45},12).wait(17));
	...
	// Frame_8
	this.instance = new lib.Frame8_1();
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(361).to({_off:false},0).to({_off:true},59).wait(30));

	// Frame_6
	this.instance_2 = new lib.Frame6();
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(298).to({_off:false},0).to({_off:true},63).wait(89));

	// Frame_5
	this.instance_3 = new lib.Frame5();
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(240).to({_off:false},0).to({_off:true},58).wait(152));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(118).to({_off:false},0).to({_off:true},62).wait(270));

	// Frame_2
	this.instance_6 = new lib.Frame2();
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(60).to({_off:false},0).to({_off:true},58).wait(332));
...
// library properties:
lib.properties = {
	id: 'E6DED9A87B2C774795F31DD2EA7BD0F7',
	width: 728,
	height: 90,
	fps: 24,
	color: "#FFFFFF",
	opacity: 1.00,
	manifest: [
		{src:"images/Yoga_Gen_11_Slim7i_Ultra_Aura_GDN_728x90_atlas_1.png", id:"Yoga_Gen_11_Slim7i_Ultra_Aura_GDN_728x90_atlas_1"}
	],
	preloads: []
};
...
an.compositions['E6DED9A87B2C774795F31DD2EA7BD0F7'] = {
